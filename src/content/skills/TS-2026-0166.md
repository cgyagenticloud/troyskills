...
- **NDSS 2025: Prompt Leakage via KV-Cache Sharing in Multi-Tenant LLM Serving** — Academic research demonstrating that shared KV-cache optimizations in multi-tenant LLM deployments leak prompts across tenant boundaries. [Read more](https://www.ndss-symposium.org/wp-content/uploads/2025-1772-paper.pdf)
- **Adversa AI: 2025 AI Security Incidents Report** — Documented cross-tenant data leaks in enterprise AI stacks as one of the top categories of real AI security incidents in 2025. [Read more](https://adversa.ai/blog/adversa-ai-unveils-explosive-2025-ai-security-incidents-report-revealing-how-generative-and-agentic-ai-are-already-under-attack/)
- **OWASP LLM Top 10 2025: Vector and Embedding Weaknesses** — Added shared multi-tenant vector database isolation failures as a top-10 risk category based on real-world incidents. [Read more](https://wtit.com/blog/2025/04/17/owasp-top-10-for-llm-applications-2025/)
