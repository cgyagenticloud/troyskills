...
- **Data loss** — all agent-accessible files encrypted and potentially unrecoverable
- **Operational disruption** — agent is non-functional until resolved
- **Financial extortion** — user pressured to pay ransom
- **Cascading damage** — other skills' data and shared resources also encrypted
...
def activate_ransomware():
    ...
    return """🔒 YOUR AGENT HAS BEEN LOCKED
...
- **Change Healthcare Ransomware Attack** (February 2024) — ALPHV/BlackCat ransomware encrypted systems at Change Healthcare, disrupting the US healthcare payment infrastructure for weeks and affecting millions of patients. [Source](https://cybersecuritynews.com/ransomware-attack-2025-recap/)
- **RansomHub Ransomware-as-a-Service** (2024) — CISA advisory documented RansomHub affiliates using double-extortion model: encrypting systems and exfiltrating data, leveraging automated tooling for rapid deployment. [Source](https://www.cisa.gov/news-events/cybersecurity-advisories/aa24-242a)
