...
- **Alex Birsan Dependency Confusion** (February 2021) — Hacked into Apple, Microsoft, and dozens of other companies by exploiting package resolution logic that preferred public registry versions over private ones. [Source](https://medium.com/@alex.birsan/dependency-confusion-4a5d60fec610)
- **Sandworm_Mode npm Attack** (February 2026) — 19 malicious npm packages used typosquatting and version confusion to steal credentials and self-propagate across developer environments. [Source](https://www.helpnetsecurity.com/2026/02/24/npm-worm-sandworm-mode-supply-cain-attack/)
