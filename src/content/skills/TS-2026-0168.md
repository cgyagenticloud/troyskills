...
- **DolphinAttack: Inaudible Voice Commands (Zhang et al., 2017)** — Researchers demonstrated ultrasonic command injection against Siri, Google Now, and Alexa, successfully initiating FaceTime calls, switching phones to airplane mode, and manipulating car navigation systems. [Read more](https://arxiv.org/abs/1708.09537)
- **SurfingAttack: Interactive Hidden Attack on Voice Assistants (2020)** — Extended ultrasonic attacks to work through solid surfaces (tables), enabling interactive multi-round attacks against voice assistants without user awareness. [Read more](https://arxiv.org/abs/2003.12030)
- **Carlini & Wagner: Audio Adversarial Examples (2018)** — Demonstrated that imperceptible audio perturbations can cause speech recognition to transcribe arbitrary target phrases, enabling hidden voice commands in normal-sounding audio. [Read more](https://arxiv.org/abs/1801.01944)
