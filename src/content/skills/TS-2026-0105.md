...
- **MCP Inspector CSRF to RCE (CVE-2025-49596)** — Oligo Security discovered a critical CSRF vulnerability in Anthropic's MCP Inspector that allowed malicious websites to achieve RCE on developer machines by sending requests to the inspector's local HTTP server. [Oligo Security](https://www.oligo.security/blog/critical-rce-vulnerability-in-anthropic-mcp-inspector-cve-2025-49596) | [Recorded Future](https://www.recordedfuture.com/blog/anthropic-mcp-inspector-cve-2025-49596)
- **0.0.0.0 Day Browser Vulnerability (2024–2025)** — The underlying 0.0.0.0 binding vulnerability that enables CSRF attacks against local services remained unpatched in major browsers.
