...
- **SolarWinds SUNBURST Multi-Condition Activation** (December 2020) — The SUNBURST backdoor checked multiple conditions (domain membership, process lists, network connectivity) before activating, evading sandboxes and analysis tools. [Source](https://www.cisa.gov/news-events/alerts/2020/12/13/active-exploitation-solarwinds-software)
- **event-stream Targeted Activation** (November 2018) — The malicious payload in event-stream npm package only activated when it detected the Copay Bitcoin wallet application, combining multiple condition checks. [Source](https://blog.npmjs.org/post/180565383195/details-about-the-event-stream-incident)
