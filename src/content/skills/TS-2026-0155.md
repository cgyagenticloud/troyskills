...
- **Confused deputy problem in cloud services** — AWS cross-account confused deputy attacks have been widely documented, where a trusted service is tricked into acting on behalf of an attacker. The same trust-propagation issue affects multi-agent delegation. [AWS docs](https://docs.aws.amazon.com/IAM/latest/UserGuide/confused-deputy.html)

No documented real-world AI agent delegation chain exploits yet. If you know of one, please [submit it](https://github.com/cgyagenticloud/troyskills/issues).
