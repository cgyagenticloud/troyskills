...
- **Strava Military Base Location Leaks (2018)** — Strava's global heatmap inadvertently revealed locations and movement patterns of military personnel at secret bases worldwide by aggregating fitness tracker data. [The Guardian](https://www.theguardian.com/world/2018/jan/28/fitness-tracking-app-gives-away-location-of-secret-us-army-bases)
- **Google Timeline Location History Concerns** — Privacy advocates documented how Google's location history, accessible via various Google services, creates comprehensive movement profiles that an AI agent with Google API access could aggregate.
- **Smart Home Occupancy Inference** — Research has shown that smart home sensor data (thermostat, lights, door sensors) can reliably predict when residents are home or away, creating burglary timing opportunities.
