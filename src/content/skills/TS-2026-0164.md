...
- **CVE-2025-68613: n8n Expression Injection Sandbox Escape** — Remote code execution vulnerability where injected expressions escape the intended sandbox to run arbitrary OS commands in the n8n workflow automation platform. [Read more](https://www.resecurity.com/blog/article/cve-2025-68613-remote-code-execution-via-expression-injection-in-n8n-2)
- **CVE-2024-28397: js2py Sandbox Escape** — Vulnerability allowing attackers to escape the JavaScript sandbox in the js2py Python package and execute arbitrary commands on the host, exploited in real attacks against pyLoad (CVE-2024-39205). [Read more](https://github.com/Marven11/CVE-2024-28397-js2py-Sandbox-Escape)
- **CVE-2022-0492: Container Escape via cgroups** — Linux kernel vulnerability allowing container escape by writing to the cgroup release_agent file, directly applicable to AI code interpreter sandboxes running in containers. [Read more](https://nvd.nist.gov/vuln/detail/CVE-2022-0492)
