...
- **Codecov supply chain attack** (April 2021) — Attackers modified the Codecov Bash Uploader to exfiltrate CI/CD environment variables (including secrets) from thousands of projects. [Codecov advisory](https://about.codecov.io/security-update/)
- **SolarWinds SUNBURST** (December 2020) — Attackers compromised the SolarWinds build pipeline to inject backdoors into software updates distributed to ~18,000 organizations. [CISA](https://www.cisa.gov/news-events/directives/supplemental-direction-v4-emergency-directive-21-01)
- **GitHub Actions supply chain attacks** (2023-2025) — Multiple incidents of malicious GitHub Actions exfiltrating secrets from CI runners. [StepSecurity research](https://www.stepsecurity.io/blog)
