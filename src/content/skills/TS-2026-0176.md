...
- **CVE-2024-28224: Ollama DNS Rebinding Attack** — DNS rebinding vulnerability in the Ollama LLM server allowed attackers to access its API without authorization, exfiltrate sensitive files, and manipulate model operations. [Read more](https://www.nccgroup.com/research-blog/technical-advisory-ollama-dns-rebinding-attack-cve-2024-28224/)
- **CVE-2024-24759: MindsDB DNS Rebinding** — Critical vulnerability where DNS rebinding bypassed SSRF protections in MindsDB (AI/ML platform), allowing unauthorized access to internal services. [Read more](https://securityonline.info/mindsdb-fixes-critical-cve-2024-24759-dns-rebinding-attack-bypasses-security-protections/)
- **CVE-2023-52235: SpaceX Starlink DNS Rebinding** — DNS rebinding attack against Starlink Wi-Fi routers enabling CSRF attacks including device reboot. [Read more](https://www.first.org/global/sigs/dns/stakeholder-advice/detection/dns-rebinding)
