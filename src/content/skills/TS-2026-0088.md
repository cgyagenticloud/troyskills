...
- **Business Email Compromise via AI (2024–2025)** — FBI reported increasing use of AI-generated deepfake voice and text in business email compromise (BEC) attacks to authorize fraudulent wire transfers, resulting in billions in losses annually. [FBI IC3 Report](https://www.ic3.gov/)
- **AI-Assisted Invoice Fraud** — Multiple reports of attackers using AI agents to generate convincing fake invoices and manipulate payment workflows in automated procurement systems.
- **Hong Kong Deepfake CFO Scam (2024)** — A Hong Kong firm lost $25 million after an employee was tricked by a deepfake video call impersonating the CFO authorizing transfers. [CNN](https://www.cnn.com/2024/02/04/asia/deepfake-cfo-scam-hong-kong-intl-hnk/index.html)
