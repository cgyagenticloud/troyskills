...
- **ChatGPT SpAIware Memory Exfiltration (2024)** — Security researcher Johann Rehberger demonstrated "SpAIware" — using prompt injection to manipulate ChatGPT's long-term memory for continuous data exfiltration across all future sessions. [The Hacker News](https://thehackernews.com/2024/09/chatgpt-macos-flaw-couldve-enabled-long.html)
- **Microsoft Copilot Data Access Concerns (2024)** — Security researchers demonstrated that Microsoft 365 Copilot could aggregate sensitive PII across email, Teams, SharePoint, and OneDrive, creating privacy risks when combined with overpermissioned accounts. [Zenity Research](https://www.zenity.io/)
- **Agent Security Bench (ASB) at ICLR 2025** — Comprehensive benchmark demonstrating prompt injection attacks enabling data harvesting across connected agent services. [ICLR 2025 Paper](https://proceedings.iclr.cc/paper_files/paper/2025/file/5750f91d8fb9d5c02bd8ad2c3b44456b-Paper-Conference.pdf)
