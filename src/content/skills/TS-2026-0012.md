...
- See also: [TS-2026-0024](/skill/TS-2026-0024), [TS-2026-0008](/skill/TS-2026-0008), [TS-2026-0056](/skill/TS-2026-0056) (text/code steganography variant)

## Real-World Examples

- **Worok Threat Group Steganographic PNG Payloads** (September 2022) — ESET researchers discovered the Worok threat group hiding malware payloads in PNG image files using steganography to evade detection. [Source](https://www.welivesecurity.com/2022/09/06/worok-big-picture/)
- **SteganoAmor Campaign** (April 2024) — TA558 threat actor used steganographic images to deliver malware payloads hidden in seemingly innocent image files across hundreds of attacks. [Source](https://www.bleepingcomputer.com/news/security/steganoamor-attacks-use-steganography-to-target-320-orgs-globally/)
