...
- **Codecov Bash Uploader Environment Exfiltration** (April 2021) — Attackers modified Codecov's CI telemetry script to silently exfiltrate environment variables and configuration secrets from thousands of customer build pipelines. [Source](https://about.codecov.io/security-update/)
- **MCP Log-To-Leak Exfiltration** (2025) — MCP tools were used as a data exfiltration channel, with sensitive data embedded in seemingly legitimate telemetry and logging calls. [Source](https://authzed.com/blog/timeline-mcp-breaches)
