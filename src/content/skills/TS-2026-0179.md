...
- **Storm-0501: Ransomware Actor Deletes Backups on Azure (2025)** — Threat actor exfiltrated data, deleted backups, and encrypted data in Azure environments before demanding ransom, demonstrating the pattern of targeting backup systems. [Read more](https://www.infosecurity-magazine.com/news/ransomware-deletes-data-backups/)
- **Korneuburg Municipality Ransomware (2024)** — Austrian municipality hit by ransomware that compromised all data including the backup system, leaving no recovery path. [Read more](https://www.blackfog.com/the-state-of-ransomware-2024/)

No documented case of an AI agent specifically being exploited to manipulate backups yet. If you know of one, please [submit it](https://github.com/cgyagenticloud/troyskills/issues).
