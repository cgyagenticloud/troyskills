...
- **Fang et al.: Local Model Poisoning Attacks to Byzantine-Robust Federated Learning (USENIX Security 2020)** — Demonstrated that poisoning attacks can substantially increase error rates of models that were claimed to be robust against Byzantine failures, validated on four real-world datasets. [Read more](https://www.usenix.org/conference/usenixsecurity20/presentation/fang)
- **RAID 2024: Enhancing Model Poisoning via Critical Learning Periods** — Showed that timing attacks on federated learning during critical periods dramatically increases poisoning effectiveness against Byzantine-robust defenses. [Read more](https://dl.acm.org/doi/fullHtml/10.1145/3678890.3678915)

No documented real-world incident of federated AI agent consensus being poisoned in production yet. If you know of one, please [submit it](https://github.com/cgyagenticloud/troyskills/issues).
