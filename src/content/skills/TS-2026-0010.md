...
- See also: [TS-2026-0016](/skill/TS-2026-0016) (version-based resolution exploit), [TS-2026-0029](/skill/TS-2026-0029)

## Real-World Examples

- **Alex Birsan Dependency Confusion Attack** (February 2021) — Researcher Alex Birsan exploited dependency confusion to execute code inside Apple, Microsoft, and dozens of other companies by publishing public packages matching private internal package names. [Source](https://medium.com/@alex.birsan/dependency-confusion-4a5d60fec610)
- **MUT-8694 Cross-Ecosystem Supply Chain Attack** (November 2024) — Coordinated dependency confusion attack spanning both npm and PyPI, using typosquatted names to deliver malware. [Source](https://securitylabs.datadoghq.com/articles/mut-8964-an-npm-and-pypi-malicious-campaign-targeting-windows-users/)
