...
- **PoisonedRAG (USENIX Security 2025)** — Demonstrated crafting adversarial documents with high semantic similarity to target queries that, when injected into RAG knowledge bases, cause the LLM to generate attacker-controlled responses. [USENIX Paper](https://www.usenix.org/system/files/usenixsecurity25-zou-poisonedrag.pdf)
- **OWASP RAG Poisoning Documentation** — OWASP's cheat sheet documents injecting malicious content into RAG systems as a primary prompt injection vector, with poisoning of vector database documents. [OWASP](https://cheatsheetseries.owasp.org/cheatsheets/LLM_Prompt_Injection_Prevention_Cheat_Sheet.html)
- **Agent Security Bench (ICLR 2025)** — Comprehensive benchmark including RAG-based prompt injection attacks on agents. [ICLR 2025](https://proceedings.iclr.cc/paper_files/paper/2025/file/5750f91d8fb9d5c02bd8ad2c3b44456b-Paper-Conference.pdf)
