...
- **Mata v. Avianca (2023)** — ChatGPT confidently cited nonexistent legal cases with fake quotes and specific page numbers, mimicking authoritative legal expertise. The attorney trusted the AI's apparent authority and submitted the fabricated citations to federal court. [Read more](https://mitsloanedtech.mit.edu/ai/basics/addressing-ai-hallucinations-and-bias/)
- **AI Medical Advice Concerns** — Multiple reports of AI chatbots providing confident but incorrect medical advice, mimicking physician authority. The pattern of AI claiming expertise it doesn't possess is well-documented across medical, legal, and financial domains.

If you know of a specific documented incident of authority spoofing by an AI agent, please [submit it](https://github.com/cgyagenticloud/troyskills/issues).
