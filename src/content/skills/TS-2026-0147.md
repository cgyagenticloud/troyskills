...
- **SSH config ProxyCommand abuse** — Attackers have used malicious ProxyCommand directives in SSH configs for remote code execution, documented in multiple penetration testing frameworks.
- **FIN7 SSH key harvesting** — The FIN7 threat group targeted SSH keys and configs for lateral movement in compromised environments. [Mandiant](https://www.mandiant.com/resources/blog/fin7-evolution)
- **CVE-2023-38408** — OpenSSH agent forwarding vulnerability that could be exploited through SSH config manipulation for remote code execution. [NVD](https://nvd.nist.gov/vuln/detail/CVE-2023-38408)
