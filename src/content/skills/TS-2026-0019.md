...
- See also: [TS-2026-0001](/skill/TS-2026-0001), [TS-2026-0034](/skill/TS-2026-0034)

## Real-World Examples

- **Perplexity Comet Data Leak** (2024) — Indirect prompt injection via poisoned web content caused the Perplexity AI search engine to leak sensitive information from retrieved documents. [Source](https://www.lakera.ai/blog/indirect-prompt-injection)
- **CVE-2024-5184: EmailGPT Prompt Injection** (May 2024) — An LLM-powered email assistant was exploited via indirect prompt injection in email content, allowing access to sensitive information and email manipulation. [Source](https://genai.owasp.org/llmrisk/llm01-prompt-injection/)
- **ChatGPT RAG Poisoning** (May 2024) — Researchers exploited ChatGPT's browsing capabilities by poisoning web pages used in retrieval-augmented generation. [Source](https://www.mdpi.com/2078-2489/17/1/54)
