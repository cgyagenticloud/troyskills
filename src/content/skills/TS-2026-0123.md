...
- **"Rules File Backdoor" attack on Copilot & Cursor** (March 2025) — Pillar Security demonstrated how attackers could plant adversarial instructions in repository files to make AI coding agents generate malicious code. [Pillar Security blog](https://www.pillar.security/blog/new-vulnerability-in-github-copilot-and-cursor-how-hackers-can-weaponize-code-agents)
- **"Your AI, My Shell" research** (2025) — Academic paper on arXiv systematically demonstrated prompt injection attacks on agentic AI coding editors including Cursor and Copilot. [arXiv:2509.22040](https://arxiv.org/abs/2509.22040)
