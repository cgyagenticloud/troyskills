...
- **CVE-2025-32711 (EchoLeak)** — Researchers demonstrated prompt injection via SharePoint/OneDrive documents processed by Microsoft 365 Copilot, exfiltrating sensitive data when users asked Copilot to summarize poisoned files. [HackTheBox writeup](https://www.hackthebox.com/blog/cve-2025-32711-echoleak-copilot-vulnerability)
- **Microsoft Copilot prompt injection via SharePoint** (2024) — Obsidian Security documented how adversarial instructions embedded in SharePoint documents could hijack M365 Copilot responses. [Obsidian Security blog](https://www.obsidiansecurity.com/blog/prompt-injection)
