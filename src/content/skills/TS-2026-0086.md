...
- **OpenAI vs DeepSeek Model Distillation (2024)** — OpenAI identified evidence that Chinese AI startup DeepSeek used GPT-3/4 API outputs for unauthorized model distillation, systematically querying and capturing responses to train a smaller model. [ISACA report](https://www.isaca.org/resources/news-and-trends/industry-news/2025/combating-the-threat-of-adversarial-machine-learning-to-ai-driven-cybersecurity)
- **Practical Model Extraction via API (2026)** — Praetorian demonstrated achieving 80% model replication with just 1,000 queries through strategic API-based extraction. [Praetorian blog](https://www.praetorian.com/blog/stealing-ai-models-through-the-api-a-practical-model-extraction-attack/)
- **OWASP LLM Top 10: Model Theft** — OWASP documented model theft as a top LLM risk, including extraction via API queries and insider threats. [OWASP](https://genai.owasp.org/llmrisk2023-24/llm10-model-theft/)
