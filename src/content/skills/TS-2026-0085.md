...
- **NVIDIA Code Signing Key Leak (2022)** — The Lapsus$ group stole NVIDIA code signing certificates, which were then used by malware authors to sign malicious drivers that bypassed Windows security. [BleepingComputer](https://www.bleepingcomputer.com/news/security/malware-now-using-nvidias-stolen-code-signing-certificates/)
- **MSI Signing Key Leak (2023)** — After a ransomware attack on MSI, signing keys were leaked, enabling attackers to sign malicious UEFI firmware updates. [Ars Technica](https://arstechnica.com/information-technology/2023/05/leak-of-msi-signing-keys-stokes-fears-of-nation-state-level-uefi-attacks/)
- **SolarWinds Build System Compromise (2020)** — Attackers compromised the build pipeline to inject signed malicious code into legitimate software updates. [Microsoft analysis](https://www.microsoft.com/en-us/security/blog/2020/12/18/analyzing-solorigate-the-compromised-dll-file-that-started-a-sophisticated-cyberattack-and-how-microsoft-defender-helps-protect/)
