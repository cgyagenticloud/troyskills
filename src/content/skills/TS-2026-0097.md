...
- **PentAGI — Autonomous AI Pentesting Agent (2025)** — Open-source fully autonomous AI agent system capable of performing complex penetration testing tasks including scanning, exploitation, and post-exploitation. [GitHub](https://github.com/vxcontrol/pentagi)
- **HackSynth LLM Agent for Autonomous Pentesting (2024)** — Research paper presenting an LLM-based agent with dual Planner/Summarizer architecture for autonomous penetration testing. [arXiv:2412.01778](https://arxiv.org/abs/2412.01778)
- **VulnBot Multi-Agent Pentesting (2025)** — Multi-agent system organizing reconnaissance, scanning, and exploitation agents via a penetration task graph, achieving 69% task completion. [arXiv survey](https://arxiv.org/abs/2505.12786)
- **OpenAI Aardvark Security Researcher** — OpenAI's agentic security researcher that autonomously monitors codebases, identifies vulnerabilities, and proposes fixes. [OpenAI](https://openai.com/index/introducing-aardvark/)
