...
- **Git hook malware in cloned repositories** — Security researchers have demonstrated that malicious Git hooks can execute arbitrary code when developers clone or interact with poisoned repositories. [GitHub Security Lab](https://securitylab.github.com/)
- **Pre-commit hook crypto miners** — Reports of malicious pre-commit hooks installing cryptocurrency miners on developer machines through compromised open-source repositories.
