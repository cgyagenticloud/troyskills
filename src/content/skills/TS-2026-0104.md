...
- **MCP-Remote RCE (CVE-2025-6514)** — A critical vulnerability in the `mcp-remote` npm package allowed malicious MCP servers to achieve RCE on client machines by injecting shell commands through crafted OAuth authorization endpoint URLs. [JFrog](https://jfrog.com/blog/2025-6514-critical-mcp-remote-rce-vulnerability/) | [Docker Blog](https://www.docker.com/blog/mcp-horror-stories-the-supply-chain-attack/)
- **MCP Authorization Endpoint Exploitation Research (2025)** — Multiple security firms documented how MCP's OAuth flow could be abused for command injection. [Blog.ogwilliam.com](https://blog.ogwilliam.com/post/mcp-remote-rce-vulnerability-cve-2025-6514)
