...
- **Federated Learning Backdoor Research (2023–2025)** — Multiple papers demonstrate that poisoned model updates can embed backdoors that survive federated aggregation, with momentum-based persistence techniques. [Survey: arXiv:2301.05795](https://arxiv.org/abs/2301.05795)
- **Google Gboard Federated Learning** — Google's keyboard prediction model uses federated learning across millions of devices. Researchers have demonstrated theoretical poisoning attacks on such systems. [Google AI Blog](https://ai.googleblog.com/2017/04/federated-learning-collaborative.html)
