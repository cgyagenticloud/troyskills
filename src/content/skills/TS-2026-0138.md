...
No documented real-world examples yet. The pattern is analogous to:

- **DLL hijacking and hot-patching attacks** — Well-documented in traditional software (e.g., CVE-2020-1350 SIGRed), where replacing components during runtime enables code execution.

If you know of an AI-specific incident, please [submit it](https://github.com/cgyagenticloud/troyskills/issues).
