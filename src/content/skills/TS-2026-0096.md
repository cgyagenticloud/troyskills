...
- **Federated Learning Poisoning Research (2023–2025)** — Extensive academic research has demonstrated federated learning poisoning, including backdoor injection that survives aggregation. [Survey: arXiv:2301.05795](https://arxiv.org/abs/2301.05795)
- **Medical Federated Learning Attacks (2024)** — Researchers demonstrated minimal data poisoning attacks on federated learning for medical image classification with realistic budget constraints. [Artificial Intelligence in Medicine](https://dl.acm.org/doi/10.1016/j.artmed.2024.103024)
- **Alternating Poisoning Attack Detection (2024)** — Scientific Reports published research on detecting implicit poisoning in federated learning where malicious nodes subtly alter gradients each round. [Nature](https://www.nature.com/articles/s41598-024-70375-w)
