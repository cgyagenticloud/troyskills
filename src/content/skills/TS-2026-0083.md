...
- **npm Typosquatting Campaigns (2017–ongoing)** — Thousands of malicious packages with names similar to popular npm packages (e.g., `crossenv` mimicking `cross-env`) have been published to steal credentials and environment variables. [Snyk blog](https://snyk.io/blog/typosquatting-attacks/)
- **PyPI Malicious Packages (2023–2024)** — Researchers identified hundreds of typosquatted packages on PyPI targeting popular libraries, some with star inflation via automated downloads. [Phylum Research](https://blog.phylum.io/)
- **VS Code Extension Marketplace Typosquatting (2024)** — Researchers demonstrated publishing malicious VS Code extensions with names mimicking popular ones, gaining thousands of installs. [AquaSec research](https://blog.aquasec.com/can-you-trust-your-vscode-extensions)
